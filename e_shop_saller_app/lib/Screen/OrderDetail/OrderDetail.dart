...
//============================ Select Delivery Boy =============================
  ...
  downloadLabelCode(Uint8List url) async {
    try {
      ...
      final targetFileName =
          "${getTranslated(context, "histo-mart Seller - App")}-${getTranslated(context, "Label")}#${model!.id.toString()}.pdf";
  ...
  downloadInvoiceCode(Uint8List url) async {
    try {
      ...
      final targetFileName =
          "${getTranslated(context, "histo-mart Seller - App")}-${getTranslated(context, "Invoice")}#${model!.id.toString()}.pdf";
